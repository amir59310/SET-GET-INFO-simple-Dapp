...
function background({ GetInfo, AddressValue, BalanceValue, SetBtn, setValueInput, GetValue, SetValueBtn, GetBtn, }) {
    return (
        <div className="bg-[#252525] bg-cover min-h-screen flex items-center  justify-center">
            ...
            <div className=" bg-[#222222] max-w-sm overflow-hidden  drop-shadow-[0px_35px_20px_rgba(0,0,0,0.3)] p-6 rounded-xl animate-fade-down-for-background  ">
                ...
                <div className=" mt-9" >
                    ...
                    <div className="mt-5 mb-2">
                        ...
                        <label className="text-[#5c5c5c] font-mono font-extrabold ml-1  ">SetValue |
                        <span className="text-sm">Please input number</span>
                        </label>

                    </div >

                    <div className="flex items-center justify-center mt-1 gap-6">
                        <input value={SetBtn} onChange={(e) => setValueInput(e.target.value)} className="border-0 focus:ring-0 rounded-lg bg-[#3f3f3f] dark:text-white p-2 focus:bg-[#303030] custom-input " type="number" />
